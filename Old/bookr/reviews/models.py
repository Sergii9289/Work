...
class Contributor(models.Model):
    ...
    def number_contributions(self):  # рахує кількість елементів даного Contributor
        # в таблиці BookContributor
        return self.bookcontributor_set.count()  # зворотний зв’язок (reverse relation)
        # через поле bookcontributor_set, яке автоматично створюється Django для зв’язку
        # many-to-many між моделями Contributor та Book.
