# Generated by Django 4.2.3 on 2024-01-18 18:44
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('publication_date', models.DateField(verbose_name='Date the book was publised.')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.EmailField(help_text='Contact email for the contributor.', max_length=254)),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('date_edited', models.DateTimeField(help_text='Date and time the review was last edited.', null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('AUTHOR', 'Author'), ('CO_AUTHOR', 'Co-Author'), ('EDITOR', 'Editor')], max_length=20, verbose_name='The role this contributor had in book')),
